/*
  # Database optimization and RLS setup

  1. Security
    - Enable RLS on all tables
    - Add authenticated user policies for all tables
  
  2. Performance
    - Add missing indexes for better query performance
    - Create search indexes for equipment and users
    
  3. Data integrity
    - Add missing constraints for status validation
    - Ensure role validation is compatible with existing data
*/
...
-- Update table statistics for better query planning (using ANALYZE only)
ANALYZE departments;
ANALYZE equipment;
ANALYZE categories;
ANALYZE suppliers;
