/*
  # Configuration RLS et optimisations de performance
  ...
  3. Notes importantes
    - Toutes les opérations sont sécurisées avec des vérifications d'existence
    - Les politiques RLS permettent l'accès complet aux utilisateurs authentifiés
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    WHERE c.relname = 'departments' AND n.nspname = 'public' AND c.relrowsecurity = true
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_class c 
    JOIN pg_namespace n ON n.oid = c.relnamespace 
    WHERE c.relname = 'equipment' AND n.nspname = 'public' AND c.relrowsecurity = true
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_class c 
    JOIN pg_namespace n ON n.oid = c.relnamespace 
    WHERE c.relname = 'suppliers' AND n.nspname = 'public' AND c.relrowsecurity = true
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_class c 
    JOIN pg_namespace n ON n.oid = c.relnamespace 
    WHERE c.relname = 'checkouts' AND n.nspname = 'public' AND c.relrowsecurity = true
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_class c 
    JOIN pg_namespace n ON n.oid = c.relnamespace 
    WHERE c.relname = 'equipment_instances' AND n.nspname = 'public' AND c.relrowsecurity = true
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_class c 
    JOIN pg_namespace n ON n.oid = c.relnamespace 
    WHERE c.relname = 'delivery_notes' AND n.nspname = 'public' AND c.relrowsecurity = true
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_class c 
    JOIN pg_namespace n ON n.oid = c.relnamespace 
    WHERE c.relname = 'status_configs' AND n.nspname = 'public' AND c.relrowsecurity = true
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_class c 
    JOIN pg_namespace n ON n.oid = c.relnamespace 
    WHERE c.relname = 'role_configs' AND n.nspname = 'public' AND c.relrowsecurity = true
  ) THEN
