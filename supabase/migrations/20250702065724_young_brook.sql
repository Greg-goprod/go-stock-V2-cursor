/*
  # Désactivation complète de RLS et ajout de politiques d'accès

  1. Désactivation de RLS
    - Désactive RLS sur toutes les tables du système
    - Permet l'accès libre aux données pour résoudre les problèmes de lecture

  2. Politiques d'accès anonyme
    - Ajoute des politiques pour l'accès anonyme sur toutes les tables
    - Prépare le système pour une éventuelle réactivation de RLS

  3. Fonction de récupération d'équipement perdu
    - Supprime et recrée la fonction pour éviter les conflits de type
    - Permet de remettre en stock un équipement marqué comme perdu
*/
...
-- Supprimer la fonction existante si elle existe et la recréer
