/*
  # Désactivation RLS et configuration des politiques

  1. Désactivation RLS
    - Désactive RLS sur toutes les tables pour permettre un accès complet
  
  2. Politiques d'accès
    - Ajoute des politiques pour les utilisateurs anonymes et authentifiés
    - Garantit un accès complet aux données sans authentification
  
  3. Fonction de récupération d'équipement
    - Crée une fonction pour gérer la récupération des équipements perdus
*/
