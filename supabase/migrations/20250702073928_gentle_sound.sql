/*
  ...
  1. Désactivation de RLS sur toutes les tables
  2. Ajout de politiques d'accès pour anonymes et authentifiés
  3. Création de la fonction recover_lost_equipment
  4. Ajout d'index pour améliorer les performances de recherche
*/
...
-- Index pour la recherche textuelle avec pg_trgm (après avoir activé l'extension)
