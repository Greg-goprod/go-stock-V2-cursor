/*
  # Correction des index de recherche et amélioration des performances

  1. Désactivation de RLS
    - Désactive RLS sur toutes les tables pour simplifier l'accès aux données
    - Ajoute des politiques pour l'accès anonyme et authentifié

  2. Activation de l'extension pg_trgm
    - Active l'extension pg_trgm pour la recherche de texte similaire
    - Crée des index de recherche optimisés

  3. Création d'index de recherche
    - Ajoute des index pour améliorer les performances de recherche
    - Optimise spécifiquement la recherche par numéro d'article et numéro de série

  4. Fonction de récupération d'équipement perdu
    - Crée une fonction pour gérer la récupération d'équipements marqués comme perdus
*/
