/*
  # Amélioration des recherches et des index
  ...
  2. Optimisation des recherches
     - Création d'index spécialisés pour la recherche d'équipements
     - Activation de l'extension pg_trgm pour la recherche de texte similaire
     - Ajout d'index pour les numéros d'article et de série

  3. Fonction de récupération
     - Mise à jour de la fonction recover_lost_equipment
*/
