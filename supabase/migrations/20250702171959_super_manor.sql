/*
  # Ajout de QR Code pour les bons de sortie

  1. Modifications
    - Ajout d'une fonction pour générer un QR code unique pour chaque bon de sortie
    - Mise à jour du trigger de génération des numéros de bons pour inclure le QR code
    - Ajout d'un index pour améliorer les performances de recherche par QR code
  
  2. Fonctionnalités
    - Génération automatique d'un QR code unique pour chaque bon de sortie
    - Format du QR code: DN-{note_number}
    - Recherche rapide des bons de sortie par QR code
*/
