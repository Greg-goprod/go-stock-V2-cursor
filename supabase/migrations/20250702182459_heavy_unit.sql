/*
  # Ajout du QR code aux bons de sortie

  1. Modifications
    - Ajout d'une colonne `qr_code` à la table `delivery_notes`
    - Mise à jour des bons existants avec un QR code basé sur leur numéro
    - Ajout d'une contrainte d'unicité sur le QR code
    - Création d'un index pour la recherche rapide par QR code
    - Mise à jour de la fonction de génération des numéros de bons pour inclure le QR code
*/
