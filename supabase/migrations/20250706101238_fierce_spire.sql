/*
  ...
  2. Fixes
    - Resolves ambiguous column reference by using different variable names
    - Ensures proper instance generation for equipment with individual QR codes
    - Creates trigger to automatically maintain instances when equipment is updated
*/
